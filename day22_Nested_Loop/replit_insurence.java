...
public class replit_insurence {
    public static void main(String[] args) {
        ...
        referenceNumber = name.toUpperCase().substring(0,2)+age+name.toUpperCase
                ().substring(name.length()-2)+zipCode+education.toUpperCase().replaceAll(" ","");
